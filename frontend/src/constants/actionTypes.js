...
export const SUBMIT_TITLE_FILTER = "SUBMIT_TITLE_FILTER";
...
export const UPDATE_SEARCH_FIELD = "UPDATE_FIELD_EDITOR";
export const QUERY_SUBMITTED = "QUERY_SUBMITTED";
export const SEARCH_GET_CLICK = "SEARCH_GET_CLICK";
